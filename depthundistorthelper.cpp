...
void depthUndistortHelper::apply(const k4a::image &depth, k4a::image &undistorted)
{
...
pinhole_t depthUndistortHelper::create_pinhole_from_xy_range(const k4a_calibration_t *calibration, const k4a_calibration_type_t camera)
{
...
void depthUndistortHelper::create_undistortion_lut(const k4a_calibration_t *calibration,
                                    const k4a_calibration_type_t camera,
                                    const pinhole_t *pinhole,
                                    k4a_image_t lut,    //reference?
...
void depthUndistortHelper::remap(const k4a_image_t src, const k4a_image_t lut, k4a_image_t dst, interpolation_t type)
{
